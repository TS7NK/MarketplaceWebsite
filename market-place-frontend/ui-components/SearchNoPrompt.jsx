...
export default function SearchNoPrompt(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "SearchNoPrompt")}
      {...rest}
    >
      <Text
        fontFamily="Poppins"
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="@Julie’s Prompts for Sale"
        {...getOverrideProps(overrides, "@Julie\u2019s Prompts for Sale")}
      ></Text>
      <SearchBaruser
        width="570px"
        height="57px"
        ...
        {...getOverrideProps(overrides, "Search Bar (user)")}
      ></SearchBaruser>
      <Flex
        gap="80px"
        direction="column"
        ...
        >
          ...
          >
            <Icon
              ...
              left="0%"
              right="0%"
              {...getOverrideProps(overrides, "Vector50636988")}
            ></Icon>
            <View
              padding="0px 0px 0px 0px"
              width="92.03px"
              ...
              left="26.99%"
              right="26.99%"
              {...getOverrideProps(overrides, "Group50636989")}
            >
              <View
                padding="0px 0px 0px 0px"
                width="92.03px"
                ...
                left="0%"
                right="0%"
                {...getOverrideProps(overrides, "Group50636990")}
              >
                <View
                  padding="0px 0px 0px 0px"
                  width="22.37px"
                  ...
                  left="0%"
                  right="75.69%"
                  {...getOverrideProps(overrides, "Group50636991")}
                >
                  <Icon
                    width="8.27px"
                    height="21.82px"
                    ...
                    {...getOverrideProps(overrides, "Vector50636992")}
                  ></Icon>
                  <Icon
                    width="21.07px"
                    height="19.98px"
                    ...
                    left="5.79%"
                    right="0%"
                    {...getOverrideProps(overrides, "Vector50636993")}
                  ></Icon>
                </View>
                <View
                  padding="0px 0px 0px 0px"
                  ...
                  left="75.7%"
                  right="0%"
                  {...getOverrideProps(overrides, "Group50636994")}
                >
                  <Icon
                    width="8.27px"
                    height="21.82px"
                    ...
                    {...getOverrideProps(overrides, "Vector50636995")}
                  ></Icon>
                  <Icon
                    width="21.07px"
                    height="19.98px"
                    ...
                    left="0%"
                    right="5.78%"
                    {...getOverrideProps(overrides, "Vector50636996")}
                  ></Icon>
                </View>
              </View>
              <View
                ...
                left="5.3%"
                right="5.29%"
                {...getOverrideProps(overrides, "Group50636997")}
              >
                <View
                  padding="0px 0px 0px 0px"
                  width="82.29px"
                  ...
                  left="0%"
                  right="0%"
                  {...getOverrideProps(overrides, "Group50636998")}
                >
                  <Icon
                    width="81.47px"
                    height="97.48px"
                    ...
                    left="0.49%"
                    right="0.5%"
                    {...getOverrideProps(overrides, "Vector50636999")}
                  ></Icon>
                  <Icon
                    width="82.29px"
                    height="98.3px"
                    ...
                    left="0%"
                    right="0%"
                    {...getOverrideProps(overrides, "Vector50637000")}
                  ></Icon>
                </View>
                <View
                  padding="0px 0px 0px 0px"
                  ...
                  left="31.78%"
                  right="31.79%"
                  {...getOverrideProps(overrides, "Group50637001")}
                >
                  <Icon
                    width="6.77px"
                    height="6.77px"
                    ...
                    left="0%"
                    right="77.42%"
                    {...getOverrideProps(overrides, "Vector50637002")}
                  ></Icon>
                  <Icon
                    width="6.77px"
                    height="6.77px"
                    ...
                    left="77.42%"
                    right="0%"
                    {...getOverrideProps(overrides, "Vector50637003")}
                  ></Icon>
                </View>
                <View
                  padding="0px 0px 0px 0px"
                  ...
                  left="40.53%"
                  right="40.53%"
                  {...getOverrideProps(overrides, "Group50637004")}
                >
                  <Icon
                    width="14.76px"
                    height="7.11px"
                    ...
                    left="2.65%"
                    right="2.66%"
                    {...getOverrideProps(overrides, "Vector50637005")}
                  ></Icon>
                  <Icon
                    width="15.59px"
                    height="7.93px"
                    ...
                    left="0%"
                    right="0%"
                    {...getOverrideProps(overrides, "Vector50637006")}
                  ></Icon>
                </View>
              </View>
            </View>
            <Icon
              ...
              left="10.22%"
              right="10.22%"
              {...getOverrideProps(overrides, "Vector50637007")}
            ></Icon>
            <Icon
              width="51.32px"
              height="23.27px"
              ...
              left="68.31%"
              right="6.02%"
              {...getOverrideProps(overrides, "Vector50637008")}
            ></Icon>
            <Icon
              width="41.49px"
              height="20.36px"
              ...
              left="0.03%"
              right="79.22%"
              {...getOverrideProps(overrides, "Vector50637009")}
            ></Icon>
          </Flex>
          <Text
            fontFamily="Roboto"
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="No Prompts for Sale Yet"
            {...getOverrideProps(overrides, "No Prompts for Sale Yet")}
          ></Text>
        </Flex>
        <SinglePageScroll
          display="flex"
