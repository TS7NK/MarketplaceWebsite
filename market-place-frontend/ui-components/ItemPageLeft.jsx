...
export default function ItemPageLeft(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "ItemPageLeft")}
      {...rest}
    >
      <Flex
        gap="15px"
      ...
      >
        ...
        >
          <Itemphoto
            ...
            padding="0px 0px 0px 0px"
            property1="Big"
            {...getOverrideProps(overrides, "item photo43122456")}
          ></Itemphoto>
          <Itemphoto
            width="200px"
            height="200px"
            ...
            padding="0px 0px 0px 0px"
            property1="Big"
            {...getOverrideProps(overrides, "item photo43122457")}
          ></Itemphoto>
          <Itemphoto
            width="200px"
            height="200px"
            ...
            padding="0px 0px 0px 0px"
            property1="Big"
            {...getOverrideProps(overrides, "item photo43122458")}
          ></Itemphoto>
        </Flex>
        <Flex
          gap="15px"
        ...
        >
          <Scrollbuttonsmall
            ...
            {...getOverrideProps(overrides, "scroll button small43122460")}
          ></Scrollbuttonsmall>
          <Flex
            gap="10px"
            direction="row"
          ...
          <Scrollbuttonsmall
            ...
            padding="0px 0px 0px 0px"
            scrollButton="Default"
            {...getOverrideProps(overrides, "scroll button small43122468")}
          ></Scrollbuttonsmall>
        </Flex>
      </Flex>
      <Flex
      ...
      >
        ...
        >
          <Verificationtag
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "verification tag43122472")}
          ></Verificationtag>
          <Verificationtag
            display="flex"
            gap="3px"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "verification tag43122473")}
          ></Verificationtag>
        </Flex>
        <Flex
          gap="160px"
        ...
        >
          ...
          >
            ...
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 3343122477")}
            >
              <View
                width="20px"
                height="20px"
              ...
              >
                <Icon
                  ...
                  left="8.33%"
                  right="11.79%"
                  {...getOverrideProps(overrides, "Vector43122479")}
                ></Icon>
              </View>
              <Text
                fontFamily="Roboto"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 3343122482")}
          >
            <Flex
              gap="6px"
              direction="row"
            ...
            >
              <Icon
                ...
                shrink="0"
                position="relative"
                {...getOverrideProps(overrides, "Vector43122484")}
              ></Icon>
              <Text
                fontFamily="Roboto"
                fontSize="16px"
            ...
            >
              ...
              >
                <Icon
                  ...
                  left="37.5%"
                  right="37.5%"
                  {...getOverrideProps(overrides, "Vector43122488")}
                ></Icon>
                <Icon
                  width="18.75px"
                  height="13.75px"
                  ...
                  left="3.13%"
                  right="3.13%"
                  {...getOverrideProps(overrides, "Vector43122489")}
                ></Icon>
              </View>
              <Text
                fontFamily="Roboto"
