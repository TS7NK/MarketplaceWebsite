...
export default function SearchBaruser(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "SearchBaruser")}
      {...rest}
    >
      <Icon
        width="18px"
        ...
        top="20px"
        left="62px"
        {...getOverrideProps(overrides, "Vector50226758")}
      ></Icon>
      <Text
        fontFamily="Poppins"
        fontSize="16px"
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Search @Bob’s prompts..."
        {...getOverrideProps(overrides, "Search @Bob\u2019s prompts...")}
      ></Text>
      <Flex
        gap="10px"
        direction="row"
      ...
      >
        <Icon
          ...
          shrink="0"
          position="relative"
          {...getOverrideProps(overrides, "Vector50226761")}
        ></Icon>
      </Flex>
    </View>
  );
